...
export function UnifiedControlBar({
  ...
  // FIX: always prefer the actual selected product's id
  const resolvedProductId = activeProduct?.id ?? activeProductId;

  console.log("^^^^",resolvedProductId)

  const showViewButton = hasActiveSelection && !!resolvedProductId;
    ...
    >
      ...
      >
        <AnimatePresence mode="popLayout" initial={false}>
          {showViewButton ? (
            <motion.div
              key={`view-product-${resolvedProductId}`}
            ...
            >
              <Link
                ...
                state={{ selectedId: resolvedProductId }}
      ...
      <style>{`
        ...
        @media (max-height: 800px) {
          ...
          .control-bar-island { min-height: 48px !important; border-radius: 24px !important; padding: 4px !important; }
        }
        @media (max-height: 650px) {
          .control-bar-container { bottom: 16px !important; }
          .control-bar-island { min-height: 44px !important; }
        }
        @media (max-width: 768px) {
          .control-bar-container { bottom: 20px !important; }
          .control-bar-island { min-height: 48px !important; padding: 4px !important; }
        }
